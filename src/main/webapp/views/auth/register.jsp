                ...
                <div class="form-wrapper align-items-center">
                    <div class="form sign-up">
                        ...
                        <div class="input-group">
                            ...
                            <c:if test="${field_error != null}" >
                            <label style="font-size: smaller; color: red;">${field_error}</label>
                            </c:if>

                            <select class="form-select" required aria-label="select example" style="margin-top: 30px" name="field_id">
