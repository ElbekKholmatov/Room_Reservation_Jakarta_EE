...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <div class="collapse navbar-collapse" id="navbarNavDropdown">
        <ul class="navbar-nav">
            <li class="nav-item">
                <a class="nav-link" href="/book">Back</a>
            </li>
            <li class="nav-item">
...
<div class="container mt-5">
    <table id="example" class="table table-striped" style="width:100%">
        ...
        <tbody>
        <c:forEach items="${rooms}" var="reservation">
            <tr>
                <td>${i=i+1}</td>
                <td>${reservation.getKey().getName()}</td>
                <td>${reservation.getValue()}</td>
                <td>
                    <form method="get" action="user/choose-seat/${reservation.getKey().getId()}">
