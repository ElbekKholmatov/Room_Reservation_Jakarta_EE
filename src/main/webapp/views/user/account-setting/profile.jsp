...
<c:set var="field" value="${user.getField().getName()}"/>
            ...
            <div class="bg-white shadow rounded-lg d-block d-sm-flex">
                <div class="profile-tab-nav border-right">
                    ...
                    <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                        ...
                        <a class="nav-link" href="/user/active">
...
<%--&lt;%&ndash;                            <div class="col-md-6">&ndash;%&gt;  im not sure if we need this--%>
<%--                                <div class="form-group">--%>
...
<%--                            <% if ( session.getAttribute("user") != null && ((User) session.getAttribute("user")).getField() == null) {%>--%>
<%--                            <div class="col-md-6">--%>
<%--                                <label style="font-size: smaller; color: red; margin-top: -16px">You have not chosen a Field yet. Please choose a field to be able to book a room!</label>--%>
<%--                                <select class="form-select" required aria-label="select example" style="margin-top: 30px" name="fieldZ_id">--%>
...
<%--                            <%} else {%>--%>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input readonly type="text" class="form-control" value="${field}">
                                </div>
                            </div>
<%--                            <% } %>--%>
